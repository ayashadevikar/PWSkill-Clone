...
function Footer() {
    return(
        <>
            <div className="footer-section flex flex-wrap justify-around  text-white bg-black p-14">
                   <div className="footer flex flex-col  gap-y-8 text-left">
                        <img src="./images/PWSkills-white.png" className="h-16 w-[10rem]" alt="pwlogo"></img>
                        ...
                        <div className="isologo">
                            <img src="./images/iso-9001-2015.svg" className="h-32" alt="iso logo"></img>
                            <span className="iso-text ml-4">ISO 9001</span>
                        </div>
                   </div>

                   <div className="pwskill-footer flex flex-col flex-wrap gap-y-8 mt-2">
                   ...
                   <div className="product-footer mt-2 block">
